...
I want the face to look more cartoonish. So I first set up my blank canvas and started drawing 2 circles and filled them in. I used the function References from the p5.js website. 
...
Circle (60, 170, 50); ---> Circle (x, y, d)
 ...
 I then looked through the reference for how to make the mouth, I initially wanted to just do a line, but it felt bland and kinda ugly, so used the arc function. 
